...
if($objLogin->IsLoggedInAs('owner','mainadmin')){
	...
	if($tabid == '1_1') {
		...
		$tab_content_1 = '<form action="index.php?admin=settings" method="post">
			...
			<tr valign="top">
				<td width="150px">'._OFFLINE_MESSAGE.': <img class="help" src="images/question_mark.png" title="'._SITE_OFFLINE_MESSAGE_ALERT.'" alt="" /></td>
				<td colspan="2">
		    ...
		    <tr valign="top">
			    ...
			    <td colspan="2">
				    <select name="ssl_mode">
						...
						<option '.(($params["ssl_mode"] == "3") ? "selected" : "").' value="3">'._USER_ONLY.'</option>
				    </select>
			    </td>
		    </tr>
			<tr valign="top">
				<td width="150px">'._SEO_URLS.': <img class="help" src="images/question_mark.png" title="'._SEO_LINKS_ALERT.'" alt="" /></td>
				<td colspan="2">
...
&lt;/Files&gt;
	...
	$tab3=$tabs->AddTab(_DATE_AND_TIME_SETTINGS, $tab_content_3);
