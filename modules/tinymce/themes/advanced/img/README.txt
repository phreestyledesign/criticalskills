...
It's very easy to get started with ApPHP MicroCMS!!!

1. Installation:
   http://apphp.com/php-microcms/index.php?page=installation 
   or docs/Installation.htm

2. Getting Started:
   http://apphp.com/php-microcms/index.php?page=getting_started
   or docs/Getting Started.htm

3. Video Tutorial:
   http://www.apphp.com/php-microcms/index.php?page=video_tutorial


If you have any troubles, find an example of code in the folder, named "examples" 
-----------------------------------------------------------------------------------
For more information visit: 
	site 	http://apphp.com/php-microcms/index.php?page=examples
