...
if(!$objLogin->IsLoggedIn() && (ModulesSettings::Get('users', 'allow_registration') == 'yes')){
	...
	draw_title_bar(prepare_breadcrumbs(array(_USER=>'',_CREATING_NEW_ACCOUNT=>'')));
...
<?php }else{ ?>
	...
	<div class='pages_contents'>
		...
		<form action="index.php?user=create_account" method="post" name="frmRegistration" id="frmRegistration">
			...
			<tr>
				...
				<td><span class="required">*</span></td>
				<td nowrap="nowrap"><input type="password" id="frmReg_user_password1" name="user_password1" size="32" maxlength="64" value="<?php echo decode_text($user_password1);?>" autocomplete='off' /></td>
			</tr>		    
			<tr>
				<td align="<?php echo Application::Get('defined_right');?>"><?php echo _CONFIRM_PASSWORD;?></td>
				<td><span class="required">*</span></td>
				<td nowrap="nowrap"><input type="password" id="frmReg_user_password2" name="user_password2" size="32" maxlength="32" value="<?php echo decode_text($user_password2);?>" autocomplete='off' /></td>
			</tr>
