...
if($objLogin->IsLoggedInAsUser()){
	...
	draw_title_bar(prepare_breadcrumbs(array(_GENERAL=>'',_REMOVE_ACCOUNT=>'')));
...
?>
	...
	<form action="index.php?user=remove_account" method="post" name="frmProfile" onsubmit="return confirm('<?php echo _REMOVE_ACCOUNT_ALERT; ?>');">
		...
		<tr>
			<td align="left" colspan="2">
				...
				&nbsp;
				<a href="javascript:appGoTo('user=my_account');"><?php echo _BUTTON_CANCEL; ?></a>
			</td>
		</tr>
		<tr><td colspan="3">&nbsp;</td></tr>
		</table>
...
<?php
    ...
    draw_title_bar(prepare_breadcrumbs(array(_USER=>'', _REMOVE_ACCOUNT=>'')));
