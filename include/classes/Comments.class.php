...
class Comments extends MicroGrid {
	...
	//-------------------------		
	private static $PROJECT = 'MicroCMS'; // MicroCMS, BusinessDirectory, HotelSite, ShoppingCart, MedicalAppointment
	private $user_type_name = 'user';     // user/customer/customer/customer/patient
