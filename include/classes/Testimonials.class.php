...
class Testimonials extends MicroGrid {
	...
	{		
		...
		$this->arrAddModeFields = array(		    
			...
			'author_country'   => array('title'=>_COUNTRY, 'type'=>'enum',   'required'=>true, 'width'=>'210px', 'readonly'=>false, 'default'=>'AU', 'source'=>$arr_countries, 'default_option'=>'Australia', 'unique'=>false, 'javascript_event'=>''),
			'author_city'      => array('title'=>_CITY, 'type'=>'textbox', 'required'=>false, 'width'=>'210px', 'readonly'=>false, 'maxlength'=>'50', 'default'=>'Perth', 'validation_type'=>'', 'unique'=>false, 'visible'=>true),
	...
	public static function DrawTestimonials($draw = true)
	{
		...
		for($i=0; $i<$result[1]; $i++){
			...
			$output .= '<dl class="testimonial"><dt>'.$result[0][$i]['author_name'];
			$output .= '<dd>'.$result[0][$i]['testimonial_text'].'</dd></dl>';
		}
